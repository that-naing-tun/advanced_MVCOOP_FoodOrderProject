            ...
            <fieldset>
                ...
                <table class="tbl-32">
                    <tr>
                        <td><b>Name :</b></td>
                        <td>
                            <input type="text" name="name" class="input-responsiveUpdate" value="<?php echo $user['name']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><b>Email :</b></td>
                        <td>
                            <input type="text" name="email" class="input-responsiveUpdate" value="<?php echo $user['email']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="phoneNumber" class="input-responsiveUpdate" value="<?php echo $user['phone_number']; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><b>City</b> </td>
                        <td>
                            <select class="input-responsiveUpdate" id="city_list" name="city" required onchange='GetTownshipListByCityId(this.value)'>
                    ...
                    <tr>
                        <td><b>TownShip</b></td>
                        <td>
                            <select class="input-responsiveUpdate" id="township_list" name="township" required onchange='GetStreetNameListByTownshipId(this.value)'>
                    ...
                    <tr>
                        <td><b>Street</b></td>
                        <td>
                            <select class="input-responsiveUpdate" id="street_name_list" name="street_name" required>
