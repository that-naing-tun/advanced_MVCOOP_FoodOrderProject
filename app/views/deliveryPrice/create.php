        ...
        <form action="<?php echo URLROOT; ?>/DeliveryPrice/store" method="POST" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>City:</td>
                    <td>
                        <select required class="input-responsive" id="city_list" name="city" required onchange='GetTownshipListByCityId(this.value)'>

                            <option required selected="selected">Select City</option>
                            <?php
